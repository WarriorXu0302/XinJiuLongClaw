...
|---|---|
| API 端点 | 267 |
| MCP 工具 | 36（查询 14 + 操作 11 + 审批 5 + 飞书 legacy 6） |
| 数据库表 | 61 |
| 前端页面 | 60 |
| 用户角色 | 9 |
| RLS 保护表 | 14 |
...
36 个工具让 AI Agent 像人一样操作 ERP，支持双认证：
...
| 类别 | 数量 | 示例 |
|---|---|---|
| 查询 | 14 | 订单/客户/库存/利润/账户/工资/目标/稽查/补贴/考勤/政策模板/品牌/岗位/员工 |
| 操作 | 11 | 建单/收款/建客户/请假/生成工资/生成补贴/建员工/绑岗位/建账号/资金调拨/员工查询 |
| 审批 | 5 | 确认收款/审批请假/工资/目标/调拨 |
| 飞书 legacy | 6 | 对账分配/厂家审批/条码追溯/自然语言建单/政策审批提交/使用记录 |
...
- [MCP 工具文档](docs/MCP工具文档.md) — 36 个 AI Agent 工具、双认证、bridge 超时处理、调用示例
