...
|---|---|
| API 端点 | 267 |
| MCP 工具 | 64（查询 24 + 操作 23 + 审批 11 + 飞书 legacy 6） |
| 数据库表 | 61 |
| 前端页面 | 60 |
| 用户角色 | 9 |
| RLS 保护表 | 14 |
...
64 个工具让 AI Agent 像人一样操作 ERP，支持双认证：
...
| 操作 | 23 | 建单/收款/建客户/请假/建员工/绑岗位/建账号/生成工资/生成补贴/资金调拨/编辑客户/采购/费用/稽查/销售目标/订单状态/融资/商品/供应商/收货/编辑员工/结算提成 |
| 审批 | 11 | 确认收款/请假/工资/目标/调拨/采购/费用/稽查/拒绝调拨/融资还款/报销理赔 |
...
- [MCP 工具文档](docs/MCP工具文档.md) — 64 个 AI Agent 工具、双认证、bridge 超时处理、调用示例
